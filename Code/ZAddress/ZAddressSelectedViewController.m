//
//  ZAddressSelectedViewController.m
//  ZFragment
//
...
#import "ZAddressSelectedViewController.h"
...
@interface ZAddressSelectedTableViewCell : ZBaseTableViewCell
...
@end
@implementation ZAddressSelectedTableViewCell
...
@end
@interface ZAddressSelectedViewController ()

@property (nonatomic ,strong) ZAddressBridge *bridge;

@property (nonatomic ,strong) UIButton *completeItem;

@property (nonatomic ,copy) ZAddressSelectedBlock block;

@property (nonatomic ,copy) ZAddressAreaTapBlock tapBlock;
@end

@implementation ZAddressSelectedViewController


+ (instancetype)createAddressWithSelectedBlock:(ZAddressSelectedBlock) block andAreaTapBlock:(ZAddressAreaTapBlock) tapBlock{
    
    return [[ZAddressSelectedViewController alloc] initWithSelectedBlock:block andAreaTapBlock:tapBlock];
}
- (instancetype)initWithSelectedBlock:(ZAddressSelectedBlock)block andAreaTapBlock:(ZAddressAreaTapBlock) tapBlock{
...
- (void)configOwnSubViews {
    ...
    [self.tableView registerClass:[ZAddressSelectedTableViewCell class] forCellReuseIdentifier:@"cell"];
...
- (UITableViewCell *)configTableViewCell:(id)data forIndexPath:(NSIndexPath *)ip {
    ...
    ZAddressSelectedTableViewCell *cell = [self.tableView dequeueReusableCellWithIdentifier:@"cell"];
    
    if (!cell) {
        
        cell = [[ZAddressSelectedTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"cell"];
    }
